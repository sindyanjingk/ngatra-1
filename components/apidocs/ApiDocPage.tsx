        ...
        <div className="min-h-screen text-gray-800 px-6 py-12 space-y-12">
            ...
            <div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                        <Input
                            value={`https://${domain}/privateApi/getOrders?status={status}&order_ids={order_ids}&limit={limit}&offset={offset}&service_id={service_id}&token={token}`}
                            readOnly
                            className="text-sm border border-gray-700"
                        />
                        <Button size="icon" variant="outline" className="border-gray-700">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            <Input
                                value={`https://${domain}/privateApi/editOrder?order_id={order_id}&status={status}&start_count={start_count}&completions={completions}&token={token}`}
                                readOnly
                                className="text-sm border border-gray-700 text-gray-800"
                            />
                            <Button size="icon" variant="outline" className="border-gray-700">
  ...
  "ok": true
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            <Input
                                value={`https://${domain}/privateApi/incrementUserBalance?user_id={user_id}&amount={amount}`}
                                readOnly
                                className="text-sm border border-gray-700 text-gray-800"
                            />
                            <Button size="icon" variant="outline" className="border-gray-700">
  ...
  "ok": true
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-2">
                            <Input
                                value={`https://${domain}/privateApi/decrementUserBalance?user_id={user_id}&amount={amount}`}
                                readOnly
                                className="text-sm border border-gray-700 text-gray-800"
                            />
                            <Button size="icon" variant="outline" className="border-gray-700">
