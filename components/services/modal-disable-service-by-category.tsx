...
const ModalDisableServiceByCategory = ({
    catId
}: {
    catId: string
}) => {
    ...
    return (
        ...
        >
            {/* Form Header */}
            <div className="text-2xl p-6">Disabled Services By Category</div>

            {/* Form Body */}
            <div className="flex flex-col space-y-2 p-6 md:p-8">
                <div className="text-xl">Are you sure want to disabled all service for this category?</div>
            </div>
            {/* Form Actions */}
...
export default ModalDisableServiceByCategory
