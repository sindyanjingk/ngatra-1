    ...
    return (
        <motion.nav
            ...
            <div className="hidden md:flex gap-6">
                <Link href="orders" className={`hover:text-blue-400 font-bold ${pathname === "/orders" && "text-blue-500"}`}>Order</Link>
                <Link href="service" className={`hover:text-blue-400 font-bold ${pathname === "/service" && "text-blue-500"}`}>Layanan</Link>
                        ...
                        <MenubarMenu>
                            ...
                            <MenubarContent className="bg-gray-700 text-white border-gray-600">
                                <MenubarItem className="hover:bg-gray-600">
                                    ...
                                    <Link href="/login" className="ml-2 font-bold text-xl">Masuk</Link>
                                </MenubarItem>
                                <MenubarSeparator />
                                <MenubarItem className="hover:bg-gray-600">
                                    <Image src="/quit.svg" alt="quit" width={20} height={20} />
                                    <Link href="/reg" className="ml-2 font-bold text-xl">Daftar</Link>
                                </MenubarItem>
                            </MenubarContent>
                        </MenubarMenu>
                    </Menubar>
