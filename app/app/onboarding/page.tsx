...
export default async function OnboardingPage() {
    ...
    return (
        <div className="flex items-center justify-center w-screen md:p-12 flex-col gap-y-2 min-h-screen bg-gradient-to-br from-white via-blue-200 to-blue-300 p-4">
